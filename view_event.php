	...
	<div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-4 align-self-end mb-4 pt-2 page-title">
                    	<h4 class="text-center text-white" style="font-size:35px !important;"><b><?php echo ucwords($event) ?></b></h4>
                        <hr class="divider my-4" />
						<p class="text-center text-white" style="font-size:25px;"><small><b><i>Venue: <?php echo ucwords($venue) ?></small></i></b></p>
