   ...
   min-height: calc(100%)
        ...
        <header class="masthead" >
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end mb-4 page-title">
                    	<h3 class="text-white" style="font-size: 40px !important;">Welcome to <?php echo $_SESSION['system']['name']; ?></h3>
            ...
            <div class="container mt-3 pt-2">
                <h4 class="text-center text-white" style="font-size: 30px !important;"> Events</h4>
                <hr class="divider">
                <?php
                    ...
                    <div class="card-body">
                        <div class="row  align-items-center justify-content-center text-center h-100">
                            <div class="">
                                ...
                                <button class="btn btn-primary float-right read_more" style="margin-right:41px !important;" data-id="<?php echo $row['id'] ?>" >Register now</button>
                            </div>
                        </div>
